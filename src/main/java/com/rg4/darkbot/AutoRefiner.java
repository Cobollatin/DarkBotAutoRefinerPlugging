...
public class AutoRefiner implements
        ...
        Configurable<AutoRefiner.SampleConfig>, // The module has a configuration, of the class SampleModule
        // .SampleConfig
        NpcFlags<AutoRefiner.Extra>, // The module provides extra flags for npcs, they'll apear in the flags column
    ...
    public Collection<JComponent> getExtraMenuItems(PluginAPI api) {
        ...
        return Arrays.asList(
                ...
                create(i18n.get(plugin, "sample_module.menu.menu_entry"), e ->
                        Popups.of("Sample popup",
